...
export default function NavBar({ onBack, right }) {
  ...
  return (
    <nav style={{
      ...
      {onBack ? (
        <button onClick={onBack} style={{ background:"none", border:`1px solid ${BORDER}`, color:MUTED, cursor:"pointer", fontSize:13, fontFamily:"inherit", padding:"6px 14px", borderRadius:8, fontWeight:500 }}>
          ← Back
        </button>
      ) : <div style={{ width:80 }}/>}
      ...
      <div style={{ display:"flex", alignItems:"center", gap:8, cursor:"pointer" }} onClick={()=>navigate("/")}>
        ...
        <span style={{ fontFamily:"'Playfair Display',serif", fontWeight:700, fontSize:18, color:PRIMARY }}>RaYa Jobs</span>
      </div>
