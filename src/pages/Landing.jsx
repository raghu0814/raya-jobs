...
const IlluPost=()=>(
  <svg viewBox="0 0 180 140" fill="none" style={{width:"100%",maxWidth:160}}>
    ...
    <circle cx="120" cy="33" r="5" fill="#DCFCE7"/>
    <rect x="129" y="29" width="22" height="4" rx="2" fill="#86EFAC"/>
...
const IlluReward=()=>(
  <svg viewBox="0 0 180 140" fill="none" style={{width:"100%",maxWidth:160}}>
    ...
    <rect x="20" y="30" width="140" height="36" rx="14" fill="#1E3A5F"/>
    <rect x="20" y="48" width="140" height="18" fill="#1E3A5F"/>
    <rect x="34" y="38" width="26" height="18" rx="4" fill="#FCD34D" opacity="0.9"/>
    <rect x="39" y="43" width="16" height="8" rx="2" fill="#F59E0B"/>
    <text x="42" y="88" fontSize="10" fill="white" fontWeight="bold">Referral Bonus</text>
    <text x="42" y="102" fontSize="8" fill="#94A3B8">Credited by your company</text>
    <rect x="110" y="20" width="52" height="26" rx="8" fill="#DCFCE7" stroke="#86EFAC" strokeWidth="1"/>
    <text x="116" y="32" fontSize="9">✓</text>
    <rect x="128" y="27" width="26" height="4" rx="2" fill="#86EFAC"/>
...
const HeroIllus=()=>(
  <svg viewBox="0 0 440 360" fill="none" style={{width:"100%",maxWidth:440}}>
    ...
    <circle cx="56" cy="280" r="18" fill="#DCFCE7" stroke="#BBF7D0" strokeWidth="1"/>
    <text x="47" y="285" fontSize="14">🤝</text>
    <rect x="82" y="270" width="72" height="5" rx="2.5" fill={PRIMARY}/>
    <rect x="82" y="280" width="54" height="4" rx="2" fill={MUTED} opacity="0.4"/>
    <rect x="82" y="290" width="80" height="4" rx="2" fill="#86EFAC"/>
...
const StepCard=({num,title,desc,Illus,color})=>(
  <div style={{background:"white",border:`1px solid ${BORDER}`,borderRadius:20,padding:24,display:"flex",flexDirection:"column",alignItems:"center",textAlign:"center",transition:"transform 0.2s,box-shadow 0.2s",cursor:"default"}}
    ...
    <div style={{marginBottom:12,height:110,display:"flex",alignItems:"center"}}><Illus/></div>
  ...
  return(
    <div style={{fontFamily:"'Plus Jakarta Sans',sans-serif",background:BG,color:TEXT,overflowX:"hidden"}}>
      ...
      <section style={{padding:"clamp(48px,7vw,96px) clamp(16px,4vw,48px)",maxWidth:1200,margin:"0 auto",display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(280px,1fr))",gap:48,alignItems:"center"}}>
        <div>
          ...
          <p style={{color:MUTED,fontSize:"clamp(14px,2vw,17px)",lineHeight:1.8,marginBottom:28,maxWidth:480}}>
            Connect job seekers with employees who can refer them inside top IT companies. One platform — find jobs, post referrals, get hired.
          </p>
      ...
      <section style={{padding:"18px 0",overflow:"hidden",background:"white",borderBottom:`1px solid ${BORDER}`}}>
        <p style={{textAlign:"center",fontSize:11,color:MUTED,fontWeight:600,letterSpacing:"1px",marginBottom:12}}>EMPLOYEES FROM THESE COMPANIES ARE ALREADY ON RAYA</p>
